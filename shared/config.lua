...
Config.DebugPoly = true -- SET TO FALSE FOR LIVE SERVER
...
Config.CoreSettings = {
    ...
    Notify = {
        Type = 'ox', -- notification type, support for qb-core notify, okokNotify, boii_ui notify and ox_lib notify
    ...
    Inventory = {
        Type = 'ox' -- support for qb-inventory & ox_inventory
...
Config.InteractionLocations = {
    JobAreas = {
        ...
        { Name = "icecreammenu",            Location = vector3(275.22, 136.76, 104.5),  Size = vec3(0.5,0.5,0.5),   Height = 0.5,   Width = 0.5, Heading = 161.59,  MinZ = 106.0, MaxZ = 107.5,  Icon = 'fa-solid fa-user',             Label = "View Products Menu",   Job = nil,          Event = 'lusty94_icecream:client:OpenProductsMenu', Distance = 2.0,},
        ...
        { Name = "icecreamcollection",      Location = vector3(272.73, 137.3, 104.5),   Size = vec3(0.5,0.5,0.35),  Height = 0.5,   Width = 0.5, Heading = 349.0,   MinZ = 104.0, MaxZ = 105.0,  Icon = 'fa-solid fa-box-archive',      Label = "Open Collection Tray", Job = nil,          Event = 'lusty94_icecream:client:OpenCollectionTray', Distance = 2.0,},
        ...
        { Name = "icecreamsnackshelf",      Location = vector3(273.65, 137.24, 104.5),  Size = vec3(0.8,0.8,0.5),   Height = 0.8,   Width = 0.8, Heading = 159.08,  MinZ = 104.0, MaxZ = 105.75, Icon = 'fa-solid fa-cookie-bite',      Label = "Open Snack Shelf",     Job = nil,          Event = 'lusty94_icecream:client:SnackShelf', Distance = 2.0,},
    },
    Props = {
        { Model = 'xm_prop_x17_computer_01',    Coords = vector3(271.21, 126.39, 104.37),    Heading = 163.04, Icon = 'fa-solid fa-user',               Label = 'Open Management Menu',     Event = 'qb-bossmenu:client:OpenMenu',        Job = 'icecream', Distance = 2.0,}, 
        { Model = 'v_res_fridgemoda',           Coords = vector3(276.6, 132.4, 103.44),      Heading = 160.28, Icon = 'fa-solid fa-box-archive',        Label = 'Open Ingredients Fridge',  Event = 'lusty94_icecream:client:IngredientsFridge',    Job = 'icecream', Distance = 2.0,}, 
    },
}

Config.Animations = {
    PrepareSmoothies = {        dict = "mini@repair", anim = "fixing_a_player", flag = 41, },
    PrepareHotDrinks = {        dict = "mini@repair", anim = "fixing_a_player", flag = 41, },
    PrepareSoftDrinks = {       dict = "mini@repair", anim = "fixing_a_player", flag = 41, },
    PrepareIceCream = {         dict = "mini@repair", anim = "fixing_a_player", flag = 41, },
}
